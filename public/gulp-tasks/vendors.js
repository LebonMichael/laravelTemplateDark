...
gulp.task('buildOptionalVendorScripts', function() {
    ...
    var ascript71 = gulp.src(['./node_modules/jquery.easing/jquery.easing.min.js'])
...
gulp.task('buildOptionalVendorStyles', function() {
    ...
    var aStyle59 = gulp.src(['./node_modules/jstree/dist/themes/default/style.min.css'])
        .pipe(gulp.dest('./assets/vendors/jstree/themes/default'));
